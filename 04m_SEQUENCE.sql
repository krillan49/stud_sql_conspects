...
SELECT lastval();      -- lastval - функция возвращает последнее значение сгенерированное последней среди всех последовательностей в текущей сессии, не принимает аргументы
