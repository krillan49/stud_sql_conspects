...
-- 2. ALL ANY мб еще что-то работают с массивом
...
-- ARRAY_APPEND - Функция PostgreSQL добавляет указанный элемент в конец указанного массива и возвращает измененный массив.
...
-- Два UNNEST-а не дублируют друг друга ?
