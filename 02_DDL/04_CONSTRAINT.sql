...
-- В БД плохо строить валидации почти всегда. Вообще разнос бизнес-логики в разные места - такое. В БД можно делать валидацию на констрейнах и на обязательности атрибутов. Все, что свыше - семантически относится уже не к хранению, а к бизнес-логике, и должно лежать в приложении
-- В большой компании:
-- 1) у тебя не будет доступа к БД на проде
-- 2) у тебя не будет возможности залить хранимку.
