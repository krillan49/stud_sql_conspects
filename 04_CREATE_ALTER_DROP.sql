...
-- Нэйминг названий колонок и таблиц в Постгрэ - снэйк кейс
...
AUTO_INCREMENT -- (? хз насчет Постгрэ, тк там есть тип данных сериал. SQLite и MySQL есть) значение будет автоматически увеличиваться при добавление новых записей. Максимум одна такая колонка. Можно применять только к int и float.
