...
-- a - минимальное значение в наборе включительно (максимальное если шаг отрицательный)
-- b - максимальное значение в наборе включительно (минимальное если шаг отрицательный)
-- n - шаг с которым создаются значения от минимального до максимального (для целых числе по умолчанию равен 1), может быть отрицательным, если нужны значения по убыванию

-- Генерация целочисленных столбцов в блоке SELECT
SELECT GENERATE_SERIES(2, 100) AS nums;        -- Создает столбец чисел от 2 до 100 с шагом 1
