...
EXTRACT(MINUTE FROM interval '1 day 37:20:44')       -- извлекают минуты
EXTRACT(SECOND FROM interval '1 day 37:20:44')       -- извлекает секунды
...
-- [PostgreSQL] AGE(timestamp1, timestamp2) - возвращает количество лет, месяцев и дней между двумя датами до текущей даты в виде интервала:
