...
-- скалярные(возвращают 1 значени)
...
-- Часто планировщик SQL сам автоматически преобразует запросы с подзапросами в запросы с соединениями JOIN их обработкой
...
-- По соотв со значением столбца в каждой новой строке, делаем каждый раз позапрос из другой таблицы. Тут скалярный коррелированный подзапрос
