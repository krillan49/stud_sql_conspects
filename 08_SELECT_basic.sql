...
-- PostgreSQL(потом мб во всех разделах поделить на общие постгрэ итд)
...
TO_CHAR(num, '99.99')                                    -- форматирование числел, тут до 2х знаков с обойх сторон (зачемто добавляет пробед вначале)
