...
-- В PostgreSQL BOOLEAN/BOOL содеожат TRUE или FALSE, так же конвертирует в них "0 1" и "y n" "yes no"
...
SELECT 1 AS n UNION ALL SELECT 'asds' AS n; -- при объединении чиса со строкой в которой не числовые символы, преобразования не будет и СУБД выдаст ошибку
