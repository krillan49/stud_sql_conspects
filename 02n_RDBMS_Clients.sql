...
-- В дереве на БД (у нас public) нажимаем правой кнопкой мыши -> 'SQL Editor' -> 'New SQL Script'. Появится окно-редактор где можно писать и исполнять запросы. Запустить запрос можно нажав оранжевй треугольник слева сверху этого окна, либо выделить запрос и нажать Ctrl+Enter. Снизу откроется окно с результатом
...
--   Нажимаем Save и наша бд будкт создана и аоявится в Servers/PostgreSQL/Databases/ИмяБД
