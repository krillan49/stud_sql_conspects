...
-- 3NF - общепринятая и наиболее распространенная форма нормализации данных в индустрии, дальше нее, в подаляющем большинстве случаев нормализацию не проводят, тк тратить слищком много времени на нормализацию БД нерационально, за это время бизнес уже может что-то изменить и придется много раз все переделывать
